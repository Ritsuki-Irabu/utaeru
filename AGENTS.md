...
```
フェーズ：34 - スライド遷移・MV/BPM連動・詳細表示整理
対応中Issue：なし（完了Issue：#34）
ステータス：完了（詳細内MVと遷移後ミニプレーヤーの切替、MV起点のBPM連動、登録BPM曲の計測UI非表示を確認済み）
```
...
| --- | --- | --- | --- |
| 1 | 環境構築 | #1 | ✅ 完了 |
| 2 | DB設計・マイグレーション | #2 | ✅ 完了 |
| 3 | 認証API（Sanctum） | #3 | ✅ 完了 |
| 4 | ロール設定（Spatie） | #4 | ✅ 完了 |
| 5 | 公開曲マスタCRUD | #5 | ✅ 完了 |
| 6 | Spotify API連携 | #6 | ✅ 完了 |
| 7 | マイリストCRUD + タグ付け | #7 | ✅ 完了 |
| 8 | CSV出力（Laravel Excel） | #8 | ✅ 完了 |
| 9 | Vue.js + PWA環境構築 | #9 | ✅ 完了 |
| 10 | ログイン画面・Axios設定 | #10 | ✅ 完了 |
| 11 | マイリスト画面 | #11 | ✅ 完了 |
| 12 | リズム再生コンポーネント | #12 | ✅ 完了 |
| 13 | 曲検索・追加画面 | #13 | ✅ 完了 |
| 14 | 管理者画面 | #14 | ✅ 完了 |
| 15 | Playwright画面テスト・UX課題発見 | #15 | ✅ 完了 |
| 16 | プレイリスト作成・共有・音声再生 | #16 | ✅ 完了 |
| 17 | ユーザー向け曲検索・カタログ取り込み | #17 | ✅ 完了 |
| 18 | お気に入り・プレイリストUX整理、再生導線・ダークモード | #18 | ✅ 完了 |
| 19 | プレイリスト導線・CRUD責務整理 | #19 | ✅ 完了 |
| 20 | 曲詳細のYouTube MV再生 | #20 | ✅ 完了 |
| 21 | BPM自動取得・プレイリスト連続再生・曲検索UX | #21 | ✅ 完了 |
| 22 | 音楽再生・歌詞表示・BPM取得の安定化 | #22 | ✅ 完了 |
| 23 | 曲詳細カテゴリのドラッグ並び替え・YouTube API安定化 | #23 | ✅ 完了 |
| 24 | 曲タイトル紐づけ検索・管理者MV再生導線 | #24 | ✅ 完了 |
| 25 | ドラッグ挿入位置表示・プレイリスト登録UX短縮 | #25 | ✅ 完了 |
| 26 | 曲一覧の歌いだし表示・詳細開閉・BPM/MVフォールバック | #26 | ✅ 完了 |
| 27 | 曲詳細ラベル整理・MV自動再生停止・スマホPWA確認導線 | #27 | ✅ 完了 |
| 28 | 曲詳細アイコン配置・不要情報整理・歌詞プレビューUX | #28 | ✅ 完了 |
| 29 | お気に入り画面整理・検索復帰導線・詳細開閉アニメーション | #29 | ✅ 完了 |
| 30 | お気に入り状態同期・トグル操作・歌いだし補完 | #30 | ✅ 完了 |
| 31 | 詳細画面カテゴリ統一・お気に入り/プレイリスト操作 | #31 | ✅ 完了 |
| 32 | リズム再生の詳細内管理・設定メニュー・詳細操作整理 | #32 | ✅ 完了 |
| 33 | MVバックグラウンド再生・個人BPM登録・タグ作成 | #33 | ✅ 完了 |
| 34 | スライド遷移・MV/BPM連動・詳細表示整理 | #34 | ✅ 完了 |
